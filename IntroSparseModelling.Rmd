...
Sparse Modelling is a general framework to 1) choose among predictor values when n<<p, 2) increase the interpretablity of models (using fewer predictors) and 3) prevent overfitting. 
...
```{r Install packages as needed, echo=FALSE}
...
sim_slopes<-c(0, 1.1, 0.7, 0.3, 0.15, 0.05, rep(0, 95))
```
